...
export const MoreFeatures = () => {
  ...
  return (
    <motion.section
      ref={targetRef}
      style={{ opacity, y }}
      className="mx-auto flex justify-center w-full max-w-[120rem] flex-wrap gap-24 lg:gap-40 px-20 lg:px-5 py-96"
    >
      {content.map(({ icon: Icon, title, text }) => (
        <div key={title} className="flex flex-col justify-center md:justify-start items-center sm:w-[40%] md:w-[25%]">
