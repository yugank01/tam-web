...
export const SamePage = () => {
  ...
  return (
    <section ref={targetRef}>
      <div className="relative h-[200vh] md:h-[800vh]">
        <div className="sticky top-[60%] md:top-1/2 flex origin-center -translate-y-1/2 justify-center">
          <motion.div
            className="translate-x-centered-offset absolute left-1/2 top-1/2 flex w-[100vw] md:w-[50vw] -translate-y-1/2 scale-[var(--scale)] flex-col items-center justify-center "
          ...
          >
            ...
            />
            <motion.span
              className="mt-3 block text-xl sm:text-2xl text-white"
              style={{ opacity: newBranchOpacity }}
            >
              <BranchIcon className="mr-3 inline-block h-12 w-[2rem] sm:w-12" /> Feature
              branch
            </motion.span>
          </motion.div>
          <motion.div
          ...
          >
            ...
            <motion.span
              ...
              style={{ opacity: newBranchOpacity }}
            >
              <BranchIcon className="mr-3 inline-block h-12 w-[2rem] sm:w-12" /> Frontend
              FYI's branch
            </motion.span>
          </motion.div>

          <motion.p
            className="translate-y-centered-offset absolute top-1/2 left-[calc(50%-60rem)] w-[60rem] md:w-[50rem] pl-[48rem] sm:pl-[30rem] md:pl-16 text-[1.6rem] sm:text-[2.5rem] md:text-2xl leading-tight text-white"
            style={stylesWithCssVar({
        ...
        <motion.p
          ...
          className="translate-y-centered-offset top-[30%] sm:top-1/2 left-[20px] w-[300px] md:pl-16 text-xl sm:text-[3rem] md:text-2xl leading-tight text-white"
        >
          Not only share code,
          <br />
        ...
        <motion.p
          ...
          className="translate-y-centered-offset top-[80%] sm:top-1/2 pl-20 md:pl-0 sm:right-[20px] sm:w-[300px]  md:pr-16 text-[1.5rem] sm:text-xl leading-tight text-white"
        >
